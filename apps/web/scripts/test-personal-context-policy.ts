...
assert.equal(isLatestLabRequest("¿Cómo está mi glucosa?"), true);
assert.equal(isLatestLabRequest("¿Cómo está mi LDL?"), true);
assert.equal(isLatestLabRequest("¿Cómo ha evolucionado mi glucosa?"), false);
