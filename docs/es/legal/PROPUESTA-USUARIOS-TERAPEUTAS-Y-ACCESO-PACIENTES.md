...
Versión 0.2 · 2026-08-02 (original 0.1 · 2026-06-17)
Estado: **base técnica implementada** — ver ADR-018 (borrador)
ADR asociado: **ADR-018** (el número 017 reservado aquí fue asignado el
2026-07-01 a otra decisión; corregido)

> Actualización 2026-08-02: el choke point (§5) está implementado en
> `apps/web/lib/data-access.ts` + `lib/data-access-guards.ts`, con la suite de
> invariantes (§5.3) en `npm run test:data-access`, el control del invariante 7
> en `npm run check:data-access`, y las rutas de datos ya migradas. El acceso
> cruzado permanece APAGADO tras el flag `SUPPORTER_ACCESS_ENABLED` hasta que
> se cierren estatutos, guía legal y flujo de invitación de supporters.
...
- ADR-007 — Audit log append-only con hash chain · `docs/es/arquitectura/DECISIONS.md`
- ADR-005 — Sin Postgres en Fase 0/1 · `docs/es/arquitectura/DECISIONS.md`
- ADR-009 — BetterAuth sobre SQLite; MFA antes del piloto · `docs/es/arquitectura/DECISIONS.md`
...
- Guía legal del piloto · `docs/es/legal/GUIA-LEGAL-PILOTO-ALEMANIA.md`
- ADR-018 — Supporters con cubículos sobre choke point genérico · `docs/es/arquitectura/DECISIONS.md`
- Estatutos del acompañante (borrador) · `docs/es/legal/ESTATUTOS-SUPPORTER.md` · DE: `docs/de/STATUTEN-BEGLEITPERSON.md`
- Consentimiento de la persona acompañada (borrador) · `docs/es/legal/CONSENTIMIENTO-PERSONA-ACOMPANADA.md` · DE: `docs/de/EINWILLIGUNG-BEGLEITETE-PERSON.md`
- Informe de arquitectura 2026-08-02 · `docs/es/arquitectura/INFORME-ARQUITECTURA-2026-08-02.md`
