...
Cuando este documento contradiga ejemplos antiguos de `docs/es/arquitectura/ROADMAP.md`,
...
- Decisiones VitaMap: `docs/es/arquitectura/DECISIONS.md`
- Roadmap VitaMap: `docs/es/arquitectura/ROADMAP.md`
- Guía operativa: `docs/es/administracion/PILOTO-FASE1-GUIA-OPERATIVA.txt`
