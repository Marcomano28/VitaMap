...
> a `docs/es/arquitectura/ARQUITECTURA-CORPUS-TEMATICO-Y-RECUPERACION.md` (que define el marco)
> y NO sustituye a `docs/recycle/ANALISIS-BRECHAS-FASE0.md` (brechas de código/seguridad).
...
el VPS. Referencia operativa: `docs/es/administracion/PILOTO-FASE1-GUIA-OPERATIVA.txt` §G.
