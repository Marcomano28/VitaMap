...
> `docs/es/arquitectura/QMD-EVOLUCION-VITAMAP.md`. Ese documento prevalece sobre los ejemplos
...
> `docs/es/arquitectura/HOJA-DE-RUTA-MULTILINGUE-NIVELES-Y-CURIOSIDAD.md`. Ese documento
...
está en `docs/es/legal/GUIA-LEGAL-PILOTO-ALEMANIA.md`. En particular, PHQ-9, GAD-7,
